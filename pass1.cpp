...
int main()
{
    ...
    while (getline(fin, line))
    {
        ...
        if (opcode.count(word) == 0)
        {
            ...
            // if symbol already exits i.e. forward reference
            else
            {
        ...
        else if (operation == "END")
        {
            ...
            for (; litindex < littab.size(); litindex++)
            {
                ...
                littab[litindex].second = lc; //adrr assign
        ...
        else if (operation == "EQU")
        {
            ...
            {
                beforesign = word.substr(0, word.size());
            }
            ...
            while (st >> word)
            {
                ...
                else if (operation == "DS")
                {
                    ...
                    catch (const std::invalid_argument &e)
                    {
                        ...
                        std::cerr << "Invalid integer encountered: " << word << std::endl;
                    }
                }
                else if (word[0] == '=')
                {
